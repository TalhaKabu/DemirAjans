...
public class ProductController(IProductService productService, ISubCategoryService subCategoryService, ICategoryService categoryService, IColorService colorService) : ControllerBase
{
    ...
    [HttpGet("list-by-category-id-appear-in-front")]
    public async Task<IActionResult> GetListByCategoryIdAndAppearInFrontAsync(int categoryId, bool appearInFront) => Ok(await _productService.GetListByCategoryIdAndAppearInFrontAsync(categoryId, appearInFront));
