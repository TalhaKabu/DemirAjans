...
public class UserDal(ISqlDataAccess db) : IUserDal
{
    ...
    public async Task InsertAsync(UserDto userDto) => await _db.SaveDataAsync(storedProcedure: "spUsers_Insert", new { userDto.Username, userDto.Password, userDto.Name, userDto.LastName, userDto.Email, userDto.IsAdmin });
}