...
public class SubCategoryDal(ISqlDataAccess db) : ISubCategoryDal
{
    ...
    public async Task InsertAsync(SubCategoryDto subCategoryDto) => await _db.SaveDataAsync(storedProcedure: "dbo.spSubCategories_Insert",
        new { subCategoryDto.Name, subCategoryDto.ImageName, subCategoryDto.CategoryId, subCategoryDto.Code, subCategoryDto.CreationDate, subCategoryDto.LastModificationDate });
    public async Task UpdateAsync(int id, SubCategoryDto subCategoryDto) => await _db.SaveDataAsync(storedProcedure: "dbo.spSubCategories_Update",
        new { Id = id, subCategoryDto.Name, subCategoryDto.ImageName, subCategoryDto.CategoryId, subCategoryDto.Code, subCategoryDto.CreationDate, subCategoryDto.LastModificationDate });
}